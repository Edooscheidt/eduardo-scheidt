public class classePrincipal {
    public static void main(String[] args) {
        ...
        System.out.printf("a) A Aéronave que pode lavar o maior número de passageiros: %s (%d passageiros)%n",
                maiorPassageiros.getModelo(), maiorPassageiros.getPassageiros());

        System.out.printf("b) A Aéronave que pode ficar mais tempo no ar: %s (%.1f minutos)%n",
                maisTempoNoAr.getModelo(), maisTempoNoAr.calcularAutonomiaMinutos());

        System.out.printf("c) A Aéronave que consegue voar mais longe (em vel. máxima): %s (%.1f km)%n",
